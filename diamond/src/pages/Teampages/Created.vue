<template>
    <div>
      ...
      <el-drawer :visible.sync="drawer" :direction="direction" :before-close="handleClose" title="xxx的团队" style="font-size:23px;font-weight: bolder">
          ...
          <el-card :body-style="{ padding: '0px' }" shadow="hover" style="margin-bottom: 20px; -webkit-transition-duration:0.3s; -webkit-transition-timing-function:linear; -webkit-transition-delay:0.01s;">
            ...
            <div style="padding: 20px;">
              ...
              <div class="bottom clearfix">
                ...
                <el-tooltip class="item" effect="dark" content="管理权限" placement="bottom-start">
                  <el-button type="primary" icon="el-icon-more-outline" circle @click="goauthorization"></el-button>
                </el-tooltip>
              </div>
            </div>
          </el-card>
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      goauthorization(){
        this.$router.push('/workplace/team/authorization')
      },
    }
  }
</script>
