        ...
        <el-card :body-style="{ padding: '0px' }" shadow="hover" style="margin-bottom: 20px; -webkit-transition-duration:0.3s; -webkit-transition-timing-function:linear; -webkit-transition-delay:0.01s;">
          ...
          <div style="padding: 20px;">
            ...
            <div class="bottom clearfix">
              ...
              <el-tooltip class="item" effect="dark" content="彻底删除" placement="bottom-start">
                <el-button type="danger" icon="el-icon-delete" circle @click="handleDeletedoc"></el-button>
              </el-tooltip>
            </div>
          </div>
        </el-card>
...
<script>
  export default {
    ...
    methods:{
      handleDeletedoc() {
        this.$confirm('此操作将彻底删除该文档, 是否继续?', '提示', {
